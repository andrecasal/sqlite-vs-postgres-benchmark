...
> **Note:** These benchmarks were developed and tested on macOS (Apple Silicon). The setup instructions above use Homebrew. If you're on Linux, install PostgreSQL via your package manager and create the `bench` user/database equivalently.
